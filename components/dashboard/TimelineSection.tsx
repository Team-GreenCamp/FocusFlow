  ...
  return (
    <div className="flex flex-col gap-3">
      <h3 className="font-headline-sm text-base font-bold text-[#191f28] flex items-center gap-1.5 pl-1">
        <span className="material-symbols-outlined text-[#3182f6] text-lg">event_available</span>
        {formattedSelectedDate}
      </h3>
      ...
      <div className="glass-card p-5 rounded-3xl border border-[#edf1f5] shadow-sm flex flex-col justify-between">
          ...
          <div className="space-y-2.5 max-h-[220px] overflow-y-auto pr-0.5">
            {selectedDateEvents.map((event) => (
              <div
                ...
                className="p-3.5 rounded-2xl bg-[#f9fafb] border border-[#edf1f5] hover:border-[#3182f6]/30 hover:scale-[1.01] active:scale-[0.99] transition-all flex flex-col gap-1 cursor-pointer"
                title="일정 상세 조율"
              >
                <div className="flex items-start justify-between gap-1">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <span className="text-[9.5px] font-bold text-[#3182f6] bg-[#e8f3ff] px-2.5 py-0.5 rounded-full">
        ...
        <div className="border-t border-[#edf1f5] pt-3.5 mt-4 flex justify-between items-center text-[11px]">
          ...
          <button
            ...
            className="text-[#3182f6] hover:text-[#1b64da] font-extrabold flex items-center gap-0.5 transition-colors"
            type="button"
          >
            내 캘린더에 일정 등록
